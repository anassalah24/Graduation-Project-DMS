...
def create_RepVGG_AX(deploy=False):
    return RepVGG(num_blocks=[2, 4, 14, 1], num_classes=1000,
                  width_multiplier=[0.5, 0.5, 0.5, 2.5], override_groups_map=None, deploy=deploy)

def create_RepVGG_AY(deploy=False):
    return RepVGG(num_blocks=[2, 4, 14, 1], num_classes=1000,
                  width_multiplier=[0.25, 0.25, 0.25, 2.5], override_groups_map=None, deploy=deploy)
def create_RepVGG_AZ(deploy=False):
    return RepVGG(num_blocks=[1, 2, 12, 1], num_classes=1000,
...
'RepVGG-AX': create_RepVGG_AX,
'RepVGG-AY': create_RepVGG_AY,
'RepVGG-AZ': create_RepVGG_AZ,
